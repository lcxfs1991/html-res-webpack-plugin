...
describe("resource-md5-1", function () {
  it("=> md5 with compression / index chunk before react", function () {
    ...
    let assets = JSON.parse(
      fs.readFileSync(
        path.join(TEST, "dist/resource-md5-1/manifest.json"),
        "utf-8"
      ) || ""
    );
...
describe("resource-md5-2", function () {
  it("=> md5 without compression  / react chunk before index", function () {
    ...
    let assets = JSON.parse(
      fs.readFileSync(
        path.join(TEST, "dist/resource-md5-2/manifest.json"),
        "utf-8"
      ) || ""
    );
...
describe("resource-md5-3", function () {
  it("=> html mode md5 without compression", function () {
    ...
    let assets = JSON.parse(
      fs.readFileSync(
        path.join(TEST, "dist/resource-md5-3/manifest.json"),
        "utf-8"
      ) || ""
    );
...
describe("resource-md5-4", function () {
  it("=> html mode md5 with compression and without quote", function () {
    ...
    let assets = JSON.parse(
      fs.readFileSync(
        path.join(TEST, "dist/resource-md5-4/manifest.json"),
        "utf-8"
      ) || ""
    );
...
describe("resource-md5-5", function () {
  it("=> html mode md5 without compression with extension", function () {
    ...
    let assets = JSON.parse(
      fs.readFileSync(
        path.join(TEST, "dist/resource-md5-5/manifest.json"),
        "utf-8"
      ) || ""
    );
...
describe("resource-favico", function () {
  it("=> generate favicon", function () {
    ...
    let assets = JSON.parse(
      fs.readFileSync(
        path.join(TEST, "dist/resource-favico/manifest.json"),
        "utf-8"
      ) || ""
    );
...
describe("resource-favico1", function () {
  it("=> html mode generate favicon", function () {
    ...
    let assets = JSON.parse(
      fs.readFileSync(
        path.join(TEST, "dist/resource-favico-1/manifest.json"),
        "utf-8"
      ) || ""
    );
...
describe("resource-favico2", function () {
  it("=> html mode external favicon", function () {
    let distHtml = path.join(TEST, "dist/resource-favico-2/index.html"),
      resultHtml = path.join(TEST, "result/resource-favico-2/index.html");
    ...
    let assets = JSON.parse(
      fs.readFileSync(
        path.join(TEST, "dist/resource-favico-2/manifest.json"),
        "utf-8"
      ) || ""
    );
...
describe("resource-favico3", function () {
  it("=> no favicon file but fill in the option", function () {
    let distHtml = path.join(TEST, "dist/resource-favico-3/index.html"),
      resultHtml = path.join(TEST, "result/resource-favico-3/index.html");
    ...
    let assets = JSON.parse(
      fs.readFileSync(
        path.join(TEST, "dist/resource-favico-3/manifest.json"),
        "utf-8"
      ) || ""
    );
...
describe("resource-common-1", function () {
  it("=> common chunk generated by webpack", function () {
    ...
    let assets = JSON.parse(
      fs.readFileSync(
        path.join(TEST, "dist/resource-common-1/manifest.json"),
        "utf-8"
      ) || "{}"
    );
...
describe("resource-common-2", function () {
  it("=> html mode common chunk generated by webpack", function () {
    ...
    let assets = JSON.parse(
      fs.readFileSync(
        path.join(TEST, "dist/resource-common-2/manifest.json"),
        "utf-8"
      ) || ""
    );
...
describe("resource-copy-plugin-1", function () {
  it("=> usage with copy-webpack-plugin", function () {
    ...
    let assets = JSON.parse(
      fs.readFileSync(
        path.join(TEST, "dist/resource-copy-plugin-1/manifest.json"),
        "utf-8"
      ) || ""
    );
...
describe("resource-copy-plugin-2", function () {
  it("=> usage with copy-webpack-plugin with attributes", function () {
    ...
    let assets = JSON.parse(
      fs.readFileSync(
        path.join(TEST, "dist/resource-copy-plugin-2/manifest.json"),
        "utf-8"
      ) || ""
    );
...
describe("resource-copy-plugin-3", function () {
  it("=> html mode usage with copy-webpack-plugin with attributes", function () {
    ...
    let assets = JSON.parse(
      fs.readFileSync(
        path.join(TEST, "dist/resource-copy-plugin-3/manifest.json"),
        "utf-8"
      ) || ""
    );
...
describe("resource-external-1", function () {
  it("=> external resource", function () {
    ...
    let assets = JSON.parse(
      fs.readFileSync(
        path.join(TEST, "dist/resource-external-1/manifest.json"),
        "utf-8"
      ) || ""
    );
...
describe("image-in-html", function () {
  it("=> image in html", function () {
    ...
    let assets = JSON.parse(
      fs.readFileSync(
        path.join(TEST, "dist/image-in-html/manifest.json"),
        "utf-8"
      ) || ""
    );
...
describe("resource-attr-1", function () {
  it("=> resource atribute", function () {
    ...
    let assets = JSON.parse(
      fs.readFileSync(
        path.join(TEST, "dist/resource-attr-1/manifest.json"),
        "utf-8"
      ) || ""
    );
