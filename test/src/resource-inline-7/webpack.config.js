...
module.exports = {
	...
	entry: {
        index: [path.join(config.path.src, "/resource-inline-7/src/js/index")],
    },
    output: {
        publicPath: config.defaultPath,
        path: path.join(config.path.dist + '/resource-inline-7/'),
    ...
    plugins: [
        ...
        new HtmlResWebpackPlugin({
            mode: "html",
        	filename: "index.html",
            template: config.path.src + "/resource-inline-7/src/index.html",
