...
module.exports = {
	...
	entry: {
        index: [path.join(config.path.src, "/resource-inline-6/index")],
    },
    output: {
        publicPath: config.defaultPath,
        path: path.join(config.path.dist + '/resource-inline-6/'),
    ...
    plugins: [
        ...
        new HtmlResWebpackPlugin({
            mode: "html",
        	filename: "index.html",
            template: config.path.src + "/resource-inline-6/index.html",
