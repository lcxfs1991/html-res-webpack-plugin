...
module.exports = {
	...
	entry: {
        'libs/react': [path.join(config.path.src, "/resource-favico-2/libs/react")],
        'js/index': [path.join(config.path.src, "/resource-favico-2/index")],
    },
    output: {
        publicPath: config.defaultPath,
        path: path.join(config.path.dist + '/resource-favico-2/'),
    ...
    plugins: [
        ...
        new HtmlResWebpackPlugin({
            mode: "html",
        	filename: "index.html",
	        template: config.path.src + "/resource-favico-2/index.html",
            favicon: config.path.src + "/resource-favico-2/favicon.ico",
